...
CREATE TABLE IF NOT EXISTS courses (
    ...
    international_currency VARCHAR(10) NOT NULL DEFAULT 'USD',
    international_fee DECIMAL(10,2) NOT NULL DEFAULT 0,
    international_discount_fee DECIMAL(10,2) NULL DEFAULT NULL,
    certification_fee DECIMAL(10,2) NOT NULL DEFAULT 0,
    certificate_discount_fee DECIMAL(10,2) NULL DEFAULT NULL,
    international_certification_fee DECIMAL(10,2) NOT NULL DEFAULT 0,
    international_certificate_discount_fee DECIMAL(10,2) NULL DEFAULT NULL,
